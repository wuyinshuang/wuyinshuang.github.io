...
继体验过claude code的对话、@文件、图片交互模式后，笔者开始学习claude code的常用执行命令以及其他功能，在这里梳理一下方便后续随时查找。
...
Claude Code 常用命令也很方便好记，尤其是/simplify对于程序员来说主打一个安心哈哈哈。后面有时间再去多用一用skill和mcp吧~~
